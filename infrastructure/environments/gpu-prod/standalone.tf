...
module "gpu_asg" {
  ...
  # Container Registry
  ecr_repository_url = "133608785306.dkr.ecr.us-east-1.amazonaws.com/profit-sentinel-gpu"
...
output "ecr_repository" {
  ...
  value       = "133608785306.dkr.ecr.us-east-1.amazonaws.com/profit-sentinel-gpu"
}
