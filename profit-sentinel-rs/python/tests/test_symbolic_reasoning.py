...
def _make_theft_issue() -> Issue:
    ...
    return Issue(
        id="pike-creek-NegativeInventory-001",
...
def _make_quality_issue() -> Issue:
    ...
    return Issue(
        id="pike-creek-VendorShortShip-001",
...
class TestSymbolicReasoner:
    ...
    def test_explain_theft_issue(self):
        ...
        assert proof.issue_id == "pike-creek-NegativeInventory-001"
...
class TestSidecarExplainEndpoints:
    ...
    def client_with_digest(self, client):
        ...
        sidecar_module._digest_cache["pike-creek:5"] = entry
    ...
    def test_explain_endpoint(self, client_with_digest):
        ...
        resp = client_with_digest.get(
            "/api/v1/explain/pike-creek-NegativeInventory-001"
        )
        assert resp.status_code == 200
        data = resp.json()
        assert data["issue_id"] == "pike-creek-NegativeInventory-001"
    ...
    def test_backward_chain_endpoint(self, client_with_digest):
        ...
        resp = client_with_digest.post(
            "/api/v1/explain/pike-creek-NegativeInventory-001/why",
