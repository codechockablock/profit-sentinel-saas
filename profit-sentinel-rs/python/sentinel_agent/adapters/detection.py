...
2. Pike Creek Inventory — column signature match
...
from .pike_creek import PikeCreekAdapter
    ...
    if adapter is None:
        return AdapterResult(
            ...
            errors=[
                ...
                "Supported formats: Orgill PO, Pike Creek Inventory, Sales Data"
            ],
        )
