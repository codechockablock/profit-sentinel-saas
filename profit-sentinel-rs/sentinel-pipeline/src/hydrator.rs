    ...
    C: Clone + Send + Sync + 'static,
{
    ...
    ///
    /// IMPORTANT: The returned vector must have the same candidates
    /// in the same order as the input. Dropping candidates in a
    /// hydrator is not allowed — use a filter stage instead.
