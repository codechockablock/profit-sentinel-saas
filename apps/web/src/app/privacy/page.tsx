        ...
        <div className="prose prose-invert prose-emerald max-w-none">
          <section className="mb-12 bg-white/5 rounded-2xl p-8">
            ...
            <p className="text-slate-300 leading-relaxed">
              ...
              profit leaks, then delete the raw data. We only retain anonymized, aggregated statistics
              to improve our service. We never sell your data or share it with third parties.
            </p>
          </section>
          ...
          <section className="mb-12 bg-white/5 rounded-2xl p-8">
            ...
            <p className="text-slate-300 mb-6">
              We provide two levels of analysis results to protect your data while giving you actionable insights:
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-emerald-900/30 rounded-xl p-6 border border-emerald-500/30">
                ...
                <ul className="text-sm text-slate-400 space-y-2">
                  <li>Complete analysis with actual SKUs/product names</li>
                  ...
                  <li>Source files deleted immediately after sending</li>
                </ul>
              </div>
            </div>

            <p className="text-slate-400 mt-6 text-sm">
              This approach lets you see the value of our analysis before committing your email, while ensuring
              your sensitive business data (actual SKUs, prices, costs) is only sent securely to your inbox.
            </p>
          </section>
